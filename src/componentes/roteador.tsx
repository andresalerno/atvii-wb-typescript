...
// Atualizar o estado do roteador
type RoteadorState = {
    clientes: any[];
    produtos: any[];
    servicos: any[];
...
class Roteador extends Component<any, RoteadorState> {
    constructor(props: any) {
        ...
        this.setCompras = this.setCompras.bind(this);
        this.atualizarValorConsumido = this.atualizarValorConsumido.bind(this);
    }

    componentDidMount() {
        this.atualizarValorConsumido();
    }

    componentDidUpdate(prevProps: {}, prevState: RoteadorState) {
        if (prevState.compras !== this.state.compras) {
            this.atualizarValorConsumido();
        }
    }

    setClientes(novosClientes: React.SetStateAction<any[]>) {
        this.setState({ clientes: typeof novosClientes === 'function' ? novosClientes(this.state.clientes) : novosClientes });
    }

    setProdutos(novosProdutos: React.SetStateAction<any[]>) {
        this.setState({ produtos: typeof novosProdutos === 'function' ? novosProdutos(this.state.produtos) : novosProdutos });
    }

    setServicos(novosServicos: React.SetStateAction<any[]>) {
        this.setState({ servicos: typeof novosServicos === 'function' ? novosServicos(this.state.servicos) : novosServicos });
    }

    setCompras(novasCompras: React.SetStateAction<any[]>) {
        this.setState({ compras: typeof novasCompras === 'function' ? novasCompras(this.state.compras) : novasCompras });
    }
    ...
    render() {
        const { clientes, produtos, servicos, compras } = this.state;
        ...
        return (
            <Router>
                ...
                <Routes>
                    ...
                    <Route path="/clientes" element={<ListagemCliente clientes={clientes} setClientes={this.setClientes} />} />
                    <Route path="/clientes/listar" element={<ListagemCliente clientes={clientes} setClientes={this.setClientes} />} />
                    ...
                    <Route path="/clientes/genero" element={<ListagemPorGenero clientes={clientes} />} />
                    <Route path="/cadastrar-cliente" element={<CadastroCliente clientes={clientes} setClientes={this.setClientes} />} />
                    <Route path="/editar-cliente/:id" element={<EdicaoCliente clientes={clientes} setClientes={this.setClientes} />} />
                    <Route path="/produtos" element={<ListagemProduto produtos={produtos} setProdutos={this.setProdutos} />} />
                    <Route path="/cadastrar-produto" element={<CadastroProduto produtos={produtos} setProdutos={this.setProdutos} />} />
                    <Route path="/editar-produto/:id" element={<EdicaoProduto produtos={produtos} setProdutos={this.setProdutos} />} />
                    <Route path="/servicos" element={<ListagemServico servicos={servicos} setServicos={this.setServicos} />} />
                    <Route path="/cadastrar-servico" element={<CadastroServico servicos={servicos} setServicos={this.setServicos} />} />
                    <Route path="/editar-servico/:id" element={<EdicaoServico servicos={servicos} setServicos={this.setServicos} />} />
                    <Route path="/cadastrar-compra" element={<CadastroCompra clientes={clientes} produtos={produtos} servicos={servicos} setCompras={this.setCompras} />} />
